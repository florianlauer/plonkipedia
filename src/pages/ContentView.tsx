    ...
    <div className="container mx-auto py-8 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            <div className="flex flex-col items-center text-geoguessr-red">
          ...
          <div className="text-center py-12 border-2 border-dashed border-geoguessr-grey rounded-xl">
            <p className="text-xl font-medium text-geoguessr-black/60 mb-2">
              {t.noResults[language]}
            </p>
            <p className="text-geoguessr-black/40">
              {t.tryOtherFilters[language]}
            </p>
          </div>
        ) : (
          <>
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="text-sm text-geoguessr-black/60 flex items-center">
